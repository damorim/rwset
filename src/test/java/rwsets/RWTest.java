...
public class RWTest {
  ...
  public final String TEST_DIR = USER_DIR + SEP + "src" + SEP + "test" + SEP + "java";
  public final String EXAMPLES_SRC = EXAMPLES + SEP + "src";
  public final String EXAMPLES_JAR = EXAMPLES;
  public final String RESOURCES_DIR = USER_DIR + SEP + "target" + SEP + "classes"; //maven will copy the config files to this dir
  ...
  public String JAR_FILENAME = "YOU_SHOULD_HAVE_OVERWRITTEN_THIS_STRING";

...
public class Main {
  ...
  public static SimpleGraph analyze(
    ...
    // default values
    String exclusionFile = USER_DIR + SEP + "target" + SEP + "classes" + SEP + "ExclusionAllJava.txt";
    String exclusionFileForCallGraph = USER_DIR + SEP + "target" + SEP + "classes" + "exclusionFileForCallGraph";
